...
fun registerPluginJar(
    ...
    tasks.register(relocateTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        relocate("com.github.shynixn.mcutils", "com.github.shynixn.shyparticles.lib.com.github.shynixn.mcutils")
        if (isLegacy) {
            relocate(
    ...
    tasks.register(jarTaskName, com.github.jengelman.gradle.plugins.shadow.tasks.ShadowJar::class.java) {
        ...
        if (excludeOldNms) {
            val oldNmsPaths = listOf(
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_8_R3/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_9_R2/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_17_R1/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R1/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_18_R2/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R1/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R2/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_19_R3/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R1/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R2/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R3/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_20_R4/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R1/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R2/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R3/**",
                "com/github/shynixn/shyparticles/lib/com/github/shynixn/mcutils/packet/nms/v1_21_R4/**",
...
tasks.register("languageFile") {
    ...
    val contractFile = kotlinSrcFolder.resolve("com/github/shynixn/shyparticles/contract/ShyParticlesLanguage.kt")
    ...
    val implFile = kotlinSrcFolder.resolve("com/github/shynixn/shyparticles/ShyParticlesLanguageImpl.kt")
