...
class ShyParticlesPlugin : JavaPlugin(), CoroutinePlugin {
    ...
    override fun onEnable() {
        ...
        // Module
        val plugin = this
        val settings = ParticleEffectSettings().apply {
            maxParticlesPerEffect = plugin.config.getInt("engine.maxParticlesPerEffect", 1000)
            ...
            adaptivePerformance = plugin.config.getBoolean("performance.adaptivePerformance", true)
