...
class ShyParticlesDependencyInjectionModule(
    ...
    fun build(): DependencyInjectionModule {
        ...
        module.addService<ParticleEffectSettings>(settings)
        ...
        // Services
        module.addService<ParticleCommandExecutor> {
            ParticleCommandExecutor(
                module.getService(),
                module.getService(),
                module.getService(),
                module.getService(),
        ...
        module.addService<ParticleListener> {
            ParticleListener(module.getService(), module.getService())
        }
